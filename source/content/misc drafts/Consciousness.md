...
date: 2025-12-08
lastmod: 2025-12-16
description: Consciousness as a weasel word — the secular replacement for ensoulment, and the same instrument of moral exclusion.
themes:
- consciousness
- ethics
- moral status
- philosophy of mind
ai_summary: 'A shorter, sharper companion to ''I dislike qualia''. Argues that consciousness functions like ''natural'': a word whose definition shifts to suit the argument, letting strong moral claims be made without defending them. Traces its role as the secular successor to ecclesiastical ensoulment, noting that both the soul argument and the intelligence argument produce the same category of the sub-human, and that IQ-race discourse and p-zombies occupy the same structural position. Argues that what we actually respond to is the perception of consciousness rather than interiority, since a raving human receives more consideration than a crow that outperforms them. Extends the reflex nervous system and cellular sensing as cases the term cannot exclude without arbitrary cuts. Ends on four aspects worth keeping: reflexive, recursive, complex, coherent.'
ai_keywords:
- consciousness
- weasel word
- ensoulment
...
- neuroception
- crows
semantic_structure: the_word_problem > genealogy > perception_not_interiority > qualia_and_reflex > four_aspects
---
